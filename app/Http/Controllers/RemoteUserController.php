        ...
        $response = Http::withToken($token)
            ...
            ->put(env("KEYCLOAK_API_USERS_URL").$userId,[
                ...
                "attributes" => [
                    ...
                    "billing_first_name" => $data['ime'],
                    "billing_last_name" => $data['prezime'],
                    "billing_address_1" => $data['adresa'] == 'null' ? null : $data['adresa'],
                    'billing_city' => $data['mesto'] == 'null' ? null : $data['mesto'],
                    "billing_postcode" => $data['postanskiBroj'] == 'null' ? null : $data['postanskiBroj'],
                    "billing_phone" => $data['telefon1'] == 'null' ? null : $data['telefon1'],
                    "testomat" => $data['testomat'] == "true" ? 1 : 0,
                    "pedagoska_sveska" => $data["pedagoska_sveska"] == "true" ? 1 : 0,
                    "klf_korisnik" => $data["klf_korisnik"] == "true" ? 1 : 0,
                    "source" => $data['source'],
